...
const AnnotationSystem = ({ type, info,idCaller = null, index=0, recordingCode=null, trackCode=null,metaObjId=null  }) => {
  console.log("-- AnnotationSystem -- ",type," ", { type, info, idCaller, index, recordingCode, trackCode,metaObjId});
